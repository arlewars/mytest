...
class OIDCDebugger:
    ...
    def submit_and_log(self):
        ...
        try:
            ...
            log_error("Error in submit_auth_request",e)
...
def open_activedirectory_debugger():
    subprocess.Popen([sys.executable, "libs/activedirectorydebugger.py"])
...
# Add VPN indicator
    ...
    ttk.Button(sidebar, text="Active Directory Debugger", command=open_activedirectory_debugger).grid(row=14, column=0, padx=5, pady=2)

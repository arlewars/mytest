...
class OIDCDebugger:
    ...
    def setup_ui(self):
        ...
        self.endpoint_entry.grid(row=0, column=1, padx=5, pady=5, sticky="ew")
...
# Add VPN indicator
    ...
    http_request_frame.grid(row=0, column=0, sticky="nsew")
    HTTPRequest(http_request_frame, theme_var.get())

    nslookup_frame = ttk.Frame(scrollable_frame, padding="5")
    nslookup_frame.grid(row=1, column=0, sticky="nsew")
